...
<div class="container">
  <div class="address">
    <p>666 2nd Ave S<br>St Petersburg, FL 33701</p>
  </div>
  <div class="address">
    <p>727.666.9999<br>727.420.6969</p>
  </div>
  <h1>Contact Us</h1>
...
<form id="contact_form" @submit.prevent="handleSubmit">
	<div class="row">
      ...
      <div class="inputwrap"><input id="name" class="input" name="name" type="text"  v-model="name"
            required size="30"/><div class="bar"></div></div>
    
	</div>
	<div class="row">
		<label for="email">Your email:</label><br /><div class="inputwrap">
		<input id="email" class="input" name="email" type="text"  v-model="email" size="30" />
    <div class="bar"></div></div>
    <br />
	</div>
	<div class="row">
		<label for="message">Your message:</label><br />
		<div class="inputwrap"><input  v-model="message" type="textarea" /><div class="bar"></div></div>
	</div>
 ...
 data() {
  ...
  methods: {
    handleSubmit() {
      ...
      fetch("https://pinkay-and-kuro-final.herokuapp.com/contact", {
        method: "POST",
        body: JSON.stringify({
          name: this.name,
          email: this.email,
